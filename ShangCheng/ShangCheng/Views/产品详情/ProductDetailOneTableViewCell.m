...
- (void)updateProductDetailOneCellWithUseInfoDic:(ProductDetailModel *)productDetailModel withIndex:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.row) {
        case 0:
            ...
            self.contentLabel.text = productDetailModel.p_scope_crop;
            break;
        case 1:
            self.titleLabel.text = @"防治对象：";
            self.contentLabel.text = productDetailModel.p_treatment;
        ...
        case 2:
            ...
            self.contentLabel.text = productDetailModel.p_dosage;
            break;
        case 3:
            self.titleLabel.text = @"使用方法：";
            self.contentLabel.text = productDetailModel.p_method;
            break;
